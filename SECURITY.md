...
Do not publish browser profiles, exported storage, real API responses, or screenshots containing private paper content. Use a dedicated low-privilege key for local testing and configure only trusted HTTPS endpoints.
